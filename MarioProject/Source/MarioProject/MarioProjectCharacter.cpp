...
AMarioProjectCharacter::AMarioProjectCharacter()
{
...
void AMarioProjectCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMarioProjectCharacter::Move);
...
void AMarioProjectCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMarioProjectCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
